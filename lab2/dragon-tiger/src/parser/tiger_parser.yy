...
%type <Expr *> expr stringExpr intExpr seqExpr callExpr opExpr negExpr
            assignExpr whileExpr forExpr breakExpr letExpr var ifThenElseExpr;
...
expr: intExpr { $$ = $1; }
   ...
   | breakExpr { $$ = $1; }
   | letExpr { $$ = $1; }
   | ifThenElseExpr { $$ = $1; } // Добавлено правило для ifThenElseExpr
;
...
opExpr: expr PLUS expr   { $$ = new BinaryOperator(@2, $1, $3, o_plus); }
      ...
      | expr OR expr     {
        $$ = new IfThenElse(@2, $1,
                            new IfThenElse(@3, new IntegerLiteral(nl, 1), $3, new IntegerLiteral(nl, 0)),
                            $1);
      }
      ;
